...
- **Невідстежуваний (untracked)** - спочатку файли та папки у локальному репозиторії є неотслеживаемыми. Якщо файл хоч один раз додавався під контроль версій, він вже відслідковується.
